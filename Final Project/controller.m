...
%% PD controller with Range-Kutta integrator
% load ws.mat
init_t=0;
final_t=1.26;
dt=0.01;
...
% disp(theta1ref(2))
% theta1ref = zeros(N);
x0=[theta1ref(1,1) 0.1 theta2ref(1,1) 0.1]';
% u=[3 0]';
...
for i=2:N
    ...
    errorj1(i) = x(1,i) - theta1ref(i,1);
    derrorj1 = errorj1(i) - errorj1(i-1);
    Tau(1) = Tau(1)*(KPj1*errorj1(i) + KDj1*derrorj1);

    errorj2(i) = x(2,i) - theta2ref(i,1);
    derrorj2 = errorj2(i) - errorj2(i-1);
    Tau(2) = Tau(2)*(KPj2*errorj2(i) + KDj2*derrorj2);
